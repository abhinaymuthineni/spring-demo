...
import com.abhinay.demo.services.SpeakerService;
...
public class SpeakerController {
    ...
    @PostMapping("/save")
    public String saveEmployee(@Valid @ModelAttribute("speaker") Speakers speaker, Model theModel, BindingResult bindingResult){
    ...
    public String showFormForUpdate(@RequestParam("speakerId") int theId, Model theModel) {
