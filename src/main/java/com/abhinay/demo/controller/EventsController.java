...
import com.abhinay.demo.services.UsersServiceInterface;
import com.abhinay.demo.repository.MyUserDetails;
import com.abhinay.demo.services.EventsService;
...
public class EventsController {
    ...
    @Autowired
    public EventsController(EventsService eventsService, UsersServiceInterface usersService){
    ...
    @PostMapping("/save")
    public String saveEvent(@Valid @ModelAttribute("event") Events event, BindingResult bindingResult){
    ...
    public String showFormRegister(@RequestParam("eventId") int theId, Model theModel, RedirectAttributes redirAttrs) {
        Events theEvent = eventsService.getEventById(theId);
    ...
    public String eventDetails(@RequestParam("eventId") int theId, Model theModel){
        Events theEvent = eventsService.getEventById(theId);
